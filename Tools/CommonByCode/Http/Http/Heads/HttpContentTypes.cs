namespace Common.HttpHead
{
    ...
    public static class HttpContentTypes
    {
        ...
        ///<summary>ECMAScript/JavaScript; Defined in RFC 4329 (equivalent to application/ecmascript but with looser processing rules)</summary>
        ...
        public static readonly string ApplicationWwwFormUrlEncoded = "application/x-www-form-urlencoded";
